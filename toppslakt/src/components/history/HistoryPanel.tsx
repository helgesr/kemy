              ...
              {assessments.map((a, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-kemy-light dark:text-kemy-gray">{new Date(a.date).toLocaleDateString(lang === 'no' ? 'nb-NO' : 'en-GB')}</p>
                  </div>
                  ...
                  <button onClick={() => onLoad(a)} className="p-1.5 text-kemy-light hover:text-kemy-plum rounded-lg transition-colors" title={t('history.load')}>
                    <RotateCw size={14} />
                  </button>
                  <button onClick={() => onDelete(a.id)} className="p-1.5 text-kemy-light hover:text-risk-high rounded-lg transition-colors" title={t('history.delete')}>
                    <Trash2 size={14} />
                  </button>
                </div>
              ))}

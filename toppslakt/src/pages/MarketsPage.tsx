...
const images: { src: string; altKey: TranslationKey; tall: boolean }[] = [
  { src: '/images/2a1495_2fb4e8bbd52741d58cecbb28b4bfb9d6~mv2.avif', altKey: 'markets.alt1', tall: true },
  { src: '/images/2a1495_4018224aef2446baa8c2c27d0090ee61~mv2.avif', altKey: 'markets.alt2', tall: false },
  { src: '/images/2a1495_7eeecd8dc0d24a5abe11265d0b198f66~mv2.avif', altKey: 'markets.alt3', tall: false },
  { src: '/images/opt.avif', altKey: 'markets.alt4', tall: true },
];
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      >
        {images.map((img) => (
          ...
          >
            <img src={img.src} alt={t(img.altKey)} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
